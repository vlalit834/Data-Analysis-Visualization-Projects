...
- Save the plot as plots/bill_comparison.png.
...
- Save the plot as plots/body_mass_distribution.png.
...
Scatter plot saved as: plots/bill_comparison.png
Box plot saved as: plots/body_mass_distribution.png
```
...
![](plots/bill_comparison.png)

- `body_mass_distribution.png`

![](plots/body_mass_distribution.png)