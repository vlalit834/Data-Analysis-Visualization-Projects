...
def load_data():
    ...
    """
    # Create a NumPy array with the marks listed above
...
def analyze_performance(marks, average_marks):
    ...
    """
    # Filter 'marks' to find those greater than 'average_marks'
    above_average = marks[marks>average_marks]
    
    # Filter 'marks' to find those less than 35 (Fail threshold)
